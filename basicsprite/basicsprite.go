...
var tileram = (*[128]volatile.Register16)(unsafe.Pointer(uintptr(0x06010000)))

var objram = (*[128]volatile.Register8)(unsafe.Pointer(uintptr(0x07000000)))

var palram = (*[512]volatile.Register16)(unsafe.Pointer(uintptr(0x05000200)))

var vcountram = (*volatile.Register16)(unsafe.Pointer(uintptr(0x04000006)))
...
func setup() {
	...
	for i:=0; i <len(tiles); i++ {
		tileram[i].Set(tiles[i])

	}
	ioram[0].Set(0x40) // 1D Object mapping
	ioram[1].Set(0x10) // Enable tile rendering
}

func vsyncwait() {
    for vcountram.Get() >= 160 {} // wait till VDraw
    for vcountram.Get() < 160 {} // wait till VBlank
}
